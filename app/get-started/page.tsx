...
export default function GetStarted() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Provides essential personal safety, self-defense, and online safety resources.',
      icon: <FaBook className="text-4xl text-white" />,
      color: 'from-green-500 to-green-600'
    },
    {
      title: 'AI Reminders',
      description: 'AI-powered pop-up notifications for precautionary actions.',
    ...
    {
      title: 'Reward System',
      description: 'Earn points and badges for completing safety-related challenges.',
      icon: <FaTrophy className="text-4xl text-white" />,
      color: 'from-amber-500 to-amber-600'
    },
    {
      title: 'Multi-language Support',
      description: 'Ensures content is accessible to diverse users.',
